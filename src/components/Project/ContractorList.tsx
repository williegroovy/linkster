...
export default function ContractorList({ projectId, contractors } : { projectId: string, contractors: Contractors }) {
   const router = useRouter();
   const [query, setQuery] = useState('')
   const [selectedItems, setSelectedItems] = useState<Contractors>([])
